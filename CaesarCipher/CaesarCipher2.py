...
class TestCaesarCipher(unittest.TestCase):
    ...
    def test_CaesarCipher_encrypt(self):
        log.debug(CaesarCipher(self.decryptedStr, self.shift))
        self.assertEqual(
            CaesarCipher(self.decryptedStr, self.shift),
            self.encryptedStr,
            f'Not equal'
        )

    def test_CaesarCipher_decrypt(self):
        log.debug(CaesarCipher(self.encryptedStr, self.shift, 'decrypt'))
        self.assertEqual(
            CaesarCipher(self.encryptedStr, self.shift, 'decrypt'),
            self.decryptedStr,
            f'Not equal'
        )

    def test_CaesarCipher_encrypt_no_latin(self):
        self.assertRaises(
            NotImplementedError,
            CaesarCipher,
    ...
    def test_CaesarCipher_decrypt_no_latin(self):
        self.assertRaises(
            NotImplementedError,
            CaesarCipher,
            self.decryptedStr, self.shift, 'decrypt', 'arabic'
